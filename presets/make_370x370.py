#!/usr/bin/env python3
"""
make-370x370 — Автономный скрипт для создания изображений 370×370 WebP.
...
Использование:
  ...
  3. Результат появится в папке на уровень выше:
       ../имя_370x370/имя-1.webp, имя-2.webp, …
...
def main() -> None:
    ...
    print()
    print("╔══════════════════════════════════════════╗")
    print("║   make-370x370  •  WebP  •  quality 100  ║")
    print("╚══════════════════════════════════════════╝")
    print()
    ...
    # --- Пути ---
    input_dir = work_dir
    output_dir = work_dir.parent / f"{name}_370x370"
